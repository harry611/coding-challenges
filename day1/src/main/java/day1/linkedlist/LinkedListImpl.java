...
public class LinkedListImpl<E> {
	...
	public static void main(String... arg) {
		...
		System.out.println("the element popped from linked List is " + linkedList.pop());

		System.out.println("index 3 element removed from list " + linkedList.remove(3));

		System.out.println("last occurrence of 101 removed " + linkedList.removeLastOccurrence(101));
